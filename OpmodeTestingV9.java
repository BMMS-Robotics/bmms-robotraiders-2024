...
public class OpmodeTestingV8 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // New home position reset when X button is pressed
            if (gamepad2.x) {
                // Reset slide to home position
                currentSlidePosition = SLIDE_HOME;
                slide.setTargetPosition(currentSlidePosition);
                slide.setPower(0.5); // Use a bit more power to ensure it moves

                // Reset pivot to home position
                currentPivotPosition = PIVOT_HOME;
                pivotMotor.setTargetPosition(currentPivotPosition);
                pivotMotor.setPower(0.5); // Use a bit more power to ensure it moves
            }
